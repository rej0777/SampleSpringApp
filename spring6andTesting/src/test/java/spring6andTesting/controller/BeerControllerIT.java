...
import spring6andTesting.controller.BeerController;
import spring6andTesting.controller.NotFoundException;
import spring6andTesting.entities.Beer;
import spring6andTesting.mappers.BeerMapper;
...
import spring6andTesting.services.BeerService;
import spring6andTesting.services.BeerServiceImpl;
...
class BeerControllerIT {
	  @Autowired
	    ...
	    void testListBeers() {
	        ...
	        assertThat(dtos.getContent().size()).isEqualTo(100);
	    }
