package spring6andTesting.restJPA.bootstrap;
...
import spring6andTesting.restJPA.repositories.CustomerRepository;
...
public class BootstrapDataBeer implements CommandLineRunner {
	...
	/*	 
	public BootstrapDataBeer(BeerRepository beerRepository, CustomerRepository customerRepository, BeerCsvService beerCsvService) {
		super();
